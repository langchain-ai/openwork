...
function SheetContent({
  ...
  return (
    <SheetPortal>
      ...
      >
        {children}
        <SheetPrimitive.Close className="ring-offset-background focus:ring-ring data-[state=open]:bg-background-interactive absolute top-4 right-4 rounded-[3px] opacity-70 transition-opacity duration-150 hover:opacity-100 focus:ring-2 focus:ring-offset-2 focus:outline-hidden disabled:pointer-events-none">
...
function SheetTitle({
  ...
  return (
    <SheetPrimitive.Title
      ...
      className={cn("text-[11px] font-semibold uppercase tracking-[0.1em] text-foreground", className)}
      {...props}
    />
  )
}
