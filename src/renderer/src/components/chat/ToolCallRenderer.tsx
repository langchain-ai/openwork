...
// Render todos nicely
function TodosDisplay({ todos }: { todos: Todo[] }): React.ReactElement {
...
function FileContentPreview({ content }: { content: string; path?: string }): React.ReactElement {
...
function FileEditSummary({ args }: { args: Record<string, unknown> }): React.ReactElement | null {
...
export function ToolCallRenderer({
  ...
  const renderFormattedContent = (): React.ReactElement | null => {
    if (!args) return null
  ...
  const renderFormattedResult = (): React.ReactElement | null => {
